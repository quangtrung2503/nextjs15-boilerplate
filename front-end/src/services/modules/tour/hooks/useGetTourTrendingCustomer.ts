...
const requestAPI = tourCustomerServices.getTourBestTrending;

const useGetTourTrendingCustomer = (
  ...
  const save = useSave();
  const [data, setData] = useState<ResponseTourBestTrending>();
  ...
  //! Function
  const fetch: () =>
    | Promise<AxiosResponse<ResponseTourBestTrending>>
  ...
  const checkConditionPass = useCallback(
    (response: AxiosResponse<ResponseTourBestTrending>) => {
...
export default useGetTourTrendingCustomer;
