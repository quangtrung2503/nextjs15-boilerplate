...
import tourCustomerServices, {
  FiltersGetTourDestination,
  RequestGetTourDestination,
  ResponseTourDestinationList,
 ...
 ********************************************************/
const parseRequest = (
  filters: FiltersGetTourDestination,
): RequestGetTourDestination => {
  return cloneDeep({
    page: filters.page,
...
const requestAPI = tourCustomerServices.getTourDestination;

const useGetTourDestinationCustomer = (
  // filters: FiltersGetTourDestination,
  ...
  //! Function
  const fetch: () => Promise<ResponseTourDestinationList> | undefined =
    useCallback(() => {
      if (!isTrigger) {
        return;
      }
  ...
  const checkConditionPass = useCallback(
    (response: ResponseTourDestinationList) => {
...
export default useGetTourDestinationCustomer;
